...
_
**🚀 Live Demo Link**_ : 
airbnb-clone-orpin-gamma.vercel.app
...
_💡** Engineering Challenges & Learnings**_
...
**Repository Structure & Deployment Scoping:**

**Challenge:** The project root directory contained nested folders, which initially caused Vercel deployment builds to crash due to missing execution scripts.
