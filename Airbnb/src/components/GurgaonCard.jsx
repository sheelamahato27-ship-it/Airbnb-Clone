...
// We pass the "property" data into the card as a prop
const GurgaonCard = ({ property, isSeeAllCard }) => {
  ...
  return (
    <div className="flex flex-col cursor-pointer  shrink-0 w-67.5 sm:w-75 md:w-70 lg:w-73.5 snap-start ">
      ...
      <div className="relative aspect-square w-full h-50 rounded-2xl overflow-hidden  mb-3 bg-gray-100">
        ...
        {property.isFavourite && (
          <div className="absolute top-3 left-3 bg-white/95 backdrop-blur-sm text-black text-xs font-bold px-3 py-1.5 rounded-full shadow-sm border border-black/5 tracking-wide">
            Guest favourite
          </div>
        )}
        ...
        <button 
          onClick={(e) => {
            e.stopPropagation(); // Stops the user from opening the card page when just liking it
            setIsLiked(!isLiked);
          }}
          className="absolute top-3 right-3 text-white transition transform   active:scale-95 focus:outline-none drop-shadow-md"
        >
          <svg 
            ...
            viewBox="0 0 24 24"
          >
            <path d="M11.645 20.91l-.007-.003-.022-.012a15.247 15.247 0 01-.383-.218 25.18 25.18 0
             01-4.244-3.17C4.688 15.36 2.25 12.174 2.25 8.25 2.25 5.322 4.714 3 7.688 3c1.74 0 3.26.83 4.312 2.11C13.05 3.83 14.572 3 16.313 3c2.973 0 5.437 2.322 5.437 5.25 0 3.925-2.438 7.111-4.739 9.256a25.175 25.175 0 01-4.244 3.17 15.247 15.247 0 
