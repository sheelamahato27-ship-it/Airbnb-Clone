...
const BeachContent = () => {
  ...
  const destinations = [
   { city: "Carmel Beach", type: "Holiday rentals" },
  { city: "Mondello Beach", type: "Villa rentals" },
  { city: "North Beach", type: "Holiday rentals" },
  { city: "Ksamil", type: "House rentals" },
  { city: "Cabrera", type: "Villa rentals" },
  { city: "Newquay", type: "Beachfront rentals" },
  { city: "Seacrest Beach", type: "House rentals" },
  { city: "Goose Rocks Beach", type: "Holiday rentals" },
  { city: "Belmar Beach", type: "House rentals" },
  { city: "Butler Beach", type: "Holiday rentals" },
