...
const ArtsCultureContent = () => {
  ...
  const destinations = [
    { city: "Bristol Motor Speedway", type: "Holiday rentals" },
    { city: "ESPN Wide World of Sports", type: "Flat rentals" },
    { city: "Lake Como", type: "Cottage rentals" },
    { city: "Lido Key", type: "Holiday rentals" },
    ...
    { city: "Prinipe Real", type: "Apartment rentals" },
    { city: "Assateague", type: "Apartment rentals" },
    { city: "Covent Garden", type: "Flat rentals" },
  ];
  return (
    <div>
